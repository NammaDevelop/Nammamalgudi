            ...
            <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
              {PARTNERS.map((p, i) => (
                <motion.a
                  ...
                  className="px-5 py-3 rounded-md bg-[#E87B33] hover:bg-[#C25E1F] text-white text-sm sm:text-base font-medium lift-on-hover press-on-click flex items-center justify-center gap-2"
                >
                  {p.logo && (
                    <img
                      src={p.logo}
